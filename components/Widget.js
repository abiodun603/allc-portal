...
export const ButtonTypeTwo = props => (
  <BtnStyleTwo
...
export const RegisterTop = props => (
  <div className="" style={{ paddingBottom: "0.2em" }}>
    ...
    <div style={{ padding: "1em 0" }}>
      <AppButton
        ...
        bg="#fff"
        color="#3546cb"
        onPress={(e) => { e.preventDefault(); toast.error("This feature is not available at the moment") }}
      />
    </div>
    <div
      style={{
...
export const PropertyImage = props => (
  <div>
    <img src={props.img} width={30} height={30} alt="img" />
  </div>
);
